...
const EditFieldWrapper = ({
  ...
  return (
    <div className="flex flex-col md:flex-row border-b md:min-h-14 py-3 md:py-0 space-y-3 md:space-y-0 text-sm">
      ...
      >
        <div className="flex items-center space-x-2 md:min-h-12 md:py-3">
      ...
      <div className="flex-2 xl:flex-1 flex items-center md:min-h-12">
        <div className="w-full px-4 md:py-1 self-center">{children}</div>
      </div>
      {showExtra && <div className="flex-1 py-2">{extra}</div>}
    </div>
  );
};
